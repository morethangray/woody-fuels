...
We used the ordered quantile transformation for the following data subsets: total CWD; and the 1-hr, 100-hr, and 1000-hr sound fuel class subsets.
We used the square root transformation for the 10-hr, 1000-hr rotten fuel class subsets. 
...
We subset the plot-level values for coarse woody debris by fuel class, then applied an ordered quantile transformation, calculated as:
