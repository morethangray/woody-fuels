...
# Define helpers 
index_wd <- "Duff & litter"
index_wd_si <- "Mean fuel depth (centimeters)"
...
#### Summary statistics for the plot-level total amount of CWD by treatment  
...
```
#### Visualization of the plot-level total amount of CWD by treatment
